    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="text-center">
                <h1 className="text-3xl md:text-4xl font-bold font-serif text-slate-900 dark:text-brand-light mb-4">
                    Get in Touch
                </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-left max-w-2xl mx-auto bg-white dark:bg-slate-800 p-8 rounded-lg shadow-xl">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="w-full bg-slate-100 dark:bg-slate-700 border-slate-300 dark:border-slate-600 rounded-md p-3 text-slate-900 dark:text-white focus:ring-brand-primary focus:border-brand-primary transition"
